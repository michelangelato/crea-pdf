...
// $config['auth_override_class_method_http']['rest_api']['programmaScientifico']['get'] = 'none';
// $config['auth_override_class_method_http']['rest_api']['accessiEcm']['get'] = 'none';
// $config['auth_override_class_method_http']['rest_api']['accessi']['get'] = 'none';
// $config['auth_override_class_method_http']['rest_api']['attestato']['get'] = 'none';
// $config['auth_override_class_method_http']['rest_api']['attestatoPdf']['get'] = 'none';
// $config['auth_override_class_method_http']['rest_api']['luoghiDiInteresse']['get'] = 'none';
// $config['auth_override_class_method_http']['rest_api']['user']['get'] = 'none';
// $config['auth_override_class_method_http']['rest_api']['userAppLogin']['get'] = 'none';
// $config['auth_override_class_method_http']['rest_api']['toUpdate']['get'] = 'none';
// $config['auth_override_class_method_http']['rest_api']['contatoreVotanti']['get'] = 'none';
// $config['auth_override_class_method_http']['rest_api']['vota']['get'] = 'none';
// $config['auth_override_class_method_http']['rest_api']['elencoAskQuestions']['get'] = 'none';
// $config['auth_override_class_method_http']['rest_api']['elencoTelevoti']['get'] = 'none';
// $config['auth_override_class_method_http']['rest_api']['informazioniGenerali']['get'] = 'none';
// $config['auth_override_class_method_http']['rest_api']['informazioniScientifiche']['get'] = 'none';
// $config['auth_override_class_method_http']['rest_api']['accessi']['post'] = 'basic';
...
|
*/
$config['rest_valid_logins'] = ['admin' => 'jacademy_daje_2018'];
